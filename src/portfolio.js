...
const greeting = {
  ...
  subTitle: emoji(
    "Business Data Analyst skilled in SQL, Python, Power BI, process automation, reporting, and business intelligence 📈 Passionate about transforming data into actionable insights that support operational efficiency and business growth."
  ),
